...
export function formatTopLevelHelp(): string {
  return [
    ...
    "  plannotator review [--atlas] [--git | --gitbutler] [PR_URL]",
...
const SUBCOMMAND_HELP: Record<string, string> = {
  ...
  review: [
    "Usage:",
    "  plannotator review [--atlas] [--git | --gitbutler] [--local | --no-local] [PR_URL]",
    "",
    "Review local VCS changes or a GitHub/GitLab pull request in the browser.",
    "",
    "Options:",
    "  --atlas       Add Scope and Codebase Atlas views to the review",
